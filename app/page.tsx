...
import {Upload,Database,Users,Activity,Target,FileSpreadsheet,CheckCircle2,AlertCircle,BarChart3} from "lucide-react";
...
<div className="mainActions"><a className="button" href="/dashboard"><BarChart3/> Open Coach Dashboard</a><a className="button" href="/import"><FileSpreadsheet/> Open Import Workspace</a></div><div className="grid four"><Card icon={<Database/>} label="Pitches" value={rows.length.toLocaleString()}/><Card icon={<Users/>} label="Hitters" value={hitters.length}/><Card icon={<Target/>} label="Pitchers" value={pitchers.length}/><Card icon={<Activity/>} label="Avg Velocity" value={velo?velo.toFixed(1)+" mph":"—"}/></div>
